<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManageCustomersPayments.aspx.cs" Inherits="Admin_ManageCustomersPayments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnlControl" runat="server" GroupingText="CustomersPayments Control" 
        ...
        <td style="width: 147px" class="tableCell">
            <asp:Label ID="lblCustomerPaymentID" runat="server" Text="CustomerPayment ID : "></asp:Label>
            </td>
        <td>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ...
                ErrorMessage="Enter Customer ." InitialValue="0" ValidationGroup="i">*</asp:RequiredFieldValidator>
            </td>
        </tr>
            <tr>
    ...
    <asp:Panel ID="pnlShow" runat="server" GroupingText="CustomersPayments Show">
    <asp:UpdatePanel ID="upnlShow" runat="server">
        ...
        <ContentTemplate>
            ...
            <cc1:TextBoxWatermarkExtender ID="txtSearchCustomerPayment_TextBoxWatermarkExtender" 
                runat="server" Enabled="True" TargetControlID="txtSearchValue" 
                WatermarkCssClass="WaterMark" WatermarkText="Find Customer ">
            ...
            <asp:GridView ID="gvCustomersPayments" runat="server" AllowPaging="True"  
                AutoGenerateColumns="False"  DataKeyNames="CustomerPaymentID" Width="100%" 
                onpageindexchanging="gvCustomersPayments_PageIndexChanging" 
                onrowcommand="gvCustomersPayments_RowCommand">
                
                <Columns>
                    <asp:BoundField DataField="CustomerPaymentID" HeaderText="ID" ReadOnly="True" 
                        SortExpression="CustomerPaymentID" />
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="imgbtnEdit" runat="server" Height="35px" ImageAlign="Middle" ImageUrl="~/img/1270383845_edit.png" CommandName="select" CausesValidation="false" CommandArgument='<%#Eval("CustomerPaymentID") %>' AlternateText="Edit" ToolTip="Edit"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField>
                        <ItemTemplate>
                           <asp:ImageButton ID="imgbtnDelete" runat="server" Height="35px" ImageAlign="Middle" ImageUrl="~/img/delete.png" CommandArgument='<%#Eval("CustomerPaymentID") %>' CommandName="del" CausesValidation="false" AlternateText="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure ?');"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
