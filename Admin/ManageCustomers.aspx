<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManageCustomers.aspx.cs" Inherits="Admin_ManageCustomers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnlControl" runat="server" GroupingText="Customers Control" 
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="rfvCustomerName" runat="server" 
                ...
                ErrorMessage="Enter Customer Name ." ValidationGroup="i">*</asp:RequiredFieldValidator>
            </td>
        </tr>
            <tr>
    ...
    <asp:Panel ID="pnlShow" runat="server" GroupingText="Customers Show">
    <asp:UpdatePanel ID="upnlShow" runat="server">
        ...
        <ContentTemplate>
            ...
            <cc1:TextBoxWatermarkExtender ID="txtSearchCustomer_TextBoxWatermarkExtender" 
            ...
            <asp:GridView ID="gvCustomers" runat="server" AllowPaging="True"  
                AutoGenerateColumns="False"  DataKeyNames="CustomerID" Width="100%" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="imgbtnEdit" runat="server" Height="35px" ImageAlign="Middle" ImageUrl="~/img/1270383845_edit.png" CommandName="select" CausesValidation="false" CommandArgument='<%#Eval("CustomerID") %>' AlternateText="Edit" ToolTip="Edit"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField>
                        <ItemTemplate>
                           <asp:ImageButton ID="imgbtnDelete" runat="server" Height="35px" ImageAlign="Middle" ImageUrl="~/img/delete.png" CommandArgument='<%#Eval("CustomerID") %>' CommandName="del" CausesValidation="false" AlternateText="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure ?');"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
